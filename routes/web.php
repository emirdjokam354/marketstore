...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/checkout/process', 'CheckoutController@process')->name('checkout');
    ...
    Route::post('/dashboard/products/create-product', 'DashboardProductsController@store')
        ->name('dashboard-products-create-product');
    Route::get('/dashboard/products/details/{id}', 'DashboardProductsController@details')
        ->name('dashboard-products-details');
    Route::post('/dashboard/products/details/{id}', 'DashboardProductsController@update')
    ...
    Route::get('/dashboard/products/details/delete/{id}', 'DashboardProductsController@deleteGallery')
