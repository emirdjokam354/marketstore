                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="toko">Store Name</label>
                      <input
                        type="text"
                        class="form-control"
                        id="toko"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="categories_id" class="form-control">
                        @if (Auth::user()->categories_id)
                        <option value="{{ $user->categories_id }}">Tidak diganti {{ $kategori->category->name }}</option>
                        @else
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <p>Apakah saat ini toko Anda buka?</p>
                      <div
