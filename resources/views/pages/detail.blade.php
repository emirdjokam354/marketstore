                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-2" data-aos="zoom-in">
                                                ...
                                                <form action="{{ route('add-cart', $product->id) }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <button 
                                                        type="submit"
                                                        class="btn btn-success px-4 btn-block text-white mb-3">
                                                        Add to Cart
                                                        </button>
                                                </form>
                                                @else
                ...
                <section class="store-review">
                        <div class="container">
                                ...
                                <div class="row">
                                        <div class="col-12 col-lg-8">
                                                <li class="media">
                                                        <img src="/images/icon-testimonial-1.png" alt="" class="mr-3 rounded-circle" srcset="" />
                                                ...
                                                <li class="media">
                                                        <img src="/images/icon-testimonial-2.png" alt="" class="mr-3 rounded-circle" srcset="" />
                                                        <div class="media-body">
                                                ...
                                                <li class="media">
                                                        <img src="/images/icon-testimonial-3.png" alt="" class="mr-3 rounded-circle" srcset="" />
                                                        <div class="media-body">
